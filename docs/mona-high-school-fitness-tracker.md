...
def api_root(request, format=None):
    ...
    base_url = 'http://ideal-invention-rj74gxqp9pfwjpp-8000.app.github.dev/'
    return Response({
...
- Update #file:monafit-tracker/backend/monafit_tracker/views.py to replace the return for the rest api url endpiints with the codespace url http://ideal-invention-rj74gxqp9pfwjpp-8000.app.github.dev for django
- Replace <codespace-name> with ideal-invention-rj74gxqp9pfwjpp
...
{ 
    "users": "http://ideal-invention-rj74gxqp9pfwjpp-8000.app.github.dev/api/users/?format=api",
    "teams": "http://ideal-invention-rj74gxqp9pfwjpp-8000.app.github.dev/api/teams/?format=api",
    "activities": "http://ideal-invention-rj74gxqp9pfwjpp-8000.app.github.dev/api/activities/?format=api",
    "leaderboard": "http://ideal-invention-rj74gxqp9pfwjpp-8000.app.github.dev/api/leaderboard/?format=api",
    "workouts": "http://ideal-invention-rj74gxqp9pfwjpp-8000.app.github.dev/api/workouts/?format=api" 
}
```
